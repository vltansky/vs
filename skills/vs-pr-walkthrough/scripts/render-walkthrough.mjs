...
function renderSection(section, byPath, config, foldPattern) {
  ...
  return `<section class="section" id="${escapeHtml(section.id)}" data-complete="false">
    ...
    ${lede}${renderPseudocode(section.pseudocode)}${watch}${files}
  </section>`;
}
