/**
 * Framework-neutral VS live chrome contract.
 *
...
export const LIVE_UI_SURFACES = Object.freeze([
  {
    ...
    ids: [
      'vs-live-global-bar',
      'vs-live-global-bar-brand',
      'vs-live-pick-toggle',
      'vs-live-insert-toggle',
      'vs-live-detect-toggle',
      'vs-live-detect-badge',
      'vs-live-design-toggle',
      'vs-live-page-chat',
      'vs-live-page-chat-input',
      'vs-live-page-chat-voice',
    ],
    states: ['rest', 'hover', 'focus-visible', 'pressed', 'active', 'tooltip'],
  },
  {
    key: 'pending-copy-edit-dock',
    ids: ['vs-live-pending-dock'],
  ...
  },
  {
    ...
    ids: [
      ...
      'vs-live-tooltip',
      'vs-live-bar',
      'vs-live-selection-pill',
      'vs-live-input',
      'vs-live-configure-voice',
      'vs-live-configure-bar-tooltip',
    ],
  ...
  },
  {
    ...
    ids: [
      'vs-live-insert-line',
      'vs-live-insert-placeholder',
      'vs-live-placeholder-resize',
      'vs-live-insert-input',
      'vs-live-insert-voice',
      'vs-live-insert-create',
      'vs-live-insert-create-tooltip',
    ],
...
export function resolveLiveUiRoot(env = globalThis) {
  ...
  const explicit = env?.__VS_LIVE_UI_ROOT__
    || env?.window?.__VS_LIVE_UI_ROOT__;
...
export function appendToLiveUiRoot(el, env = globalThis) {
  const root = resolveLiveUiRoot(env);
  if (!root) throw new Error('VS live UI root is not available');
  root.appendChild(el);
  return el;
}
