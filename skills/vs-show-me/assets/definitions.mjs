...
${flowRailCss(".htmdx-app[data-htmdx-layout^='vs'] .vs-flow:has(> :nth-child(9))")}
  ...
  /* Catalog is a reference table, not a deck: twenty records as twenty bordered
     cards is twenty boxes of chrome the reader has to look past. One hairline
     between records and a fixed name column give the page a single scan axis -
     names down the left edge, the same field labels down the middle. */
  ...
  .htmdx-app[data-htmdx-layout^='vs'] .vs-catalog-fields dt { padding-top: 2px; white-space: nowrap; }
  .htmdx-app[data-htmdx-layout^='vs'] .vs-catalog-fields dd { margin: 0; }
