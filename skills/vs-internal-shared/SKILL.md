...
- **Building block** — owns one bounded job and can be used directly or composed by workflows (`vs-search-threads`, `vs-tdd`, `vs-qa`, `vs-brief`, `vs-tldr`, `vs-explain-diff`, `vs-verify`, `vs-deslop`, `vs-perf`, `vs-debug-mode`, `vs-roast-code`, `vs-roast-ui`, `vs-architect`, `vs-github-research`, `vs-htmdx`, `vs-rfc-research`, `vs-pushback`, `vs-prototype`, `vs-to-issues`, `vs-steal`, `vs-setup-adr`, `vs-decide-for-me`, `vs-next`, `vs-recap`, `vs-retro`, `vs-try-skill`, `vs-write`)
