...
The user-facing visual progress checkpoint (Alignment. Shaping. Your input
needed. Handoff.) lives in [`communication.md`](./communication.md). This file
owns session actions only.
