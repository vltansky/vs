...
.vs-review-composer-note { padding-top: 8px; color: #7F848E; font-size: 11px; line-height: 1.4; }
...
export function reviewOverlayFactory(css, resolveQuoteStartFn, reviewToolFactoryFn, artifactToolRegistryFactoryFn, reviewStorageKeyFn) {
  ...
  surface.innerHTML = `
    ...
    <form class="vs-review-composer vs-review-interactive" aria-label="Add review comment" hidden>
      ...
      <div class="vs-review-composer-note">After adding, send the agent a message to read comments. Comments are not checked automatically.</div>
