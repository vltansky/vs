...
export const vsLayoutCss = `
  ...
  @media screen {
    ...
    .htmdx-app[data-htmdx-layout^='vs'] .htmdx-mermaid:hover::after {
      opacity: 1;
    }
    .vs-mermaid-expand {
      position: absolute;
    ...
    .htmdx-mermaid:hover .vs-mermaid-expand,
    .vs-mermaid-expand:focus-visible {
      opacity: 1;
    }
  ...
  @media print {
    .vs-mermaid-expand { display: none; }
  }
  @media screen {
      ...
      .then((mod) => {
        ...
        const openDialog = (block) => {
          ...
          if (!dialog) {
            ...
            canvas.className = 'vs-mermaid-dialog-canvas';
            const close = document.createElement('button');
            close.type = 'button';
            close.className = 'vs-mermaid-dialog-close';
            close.textContent = 'Close';
            close.addEventListener('click', () => dialog.close());
            dialog.append(canvas, close);
          ...
          dialog.firstChild.appendChild(clone);
          dialog.showModal();
        ...
        const bind = () => {
          document.querySelectorAll('.htmdx-mermaid').forEach((block) => {
            const svg = block.querySelector('svg');
            if (!svg) return;
            if (!block.querySelector('.vs-mermaid-expand')) {
              const expand = document.createElement('button');
              expand.type = 'button';
              expand.className = 'vs-mermaid-expand';
              expand.textContent = 'Full view';
              expand.addEventListener('click', () => openDialog(block));
