...
- **Building blocks** own one bounded job and can be used directly or composed by workflows. Use these when you want precision: `/vs-pushback`, `/vs-prototype`, `/vs-github-research`, `/vs-rfc-research`, `/vs-tdd`, `/vs-debug-mode`, `/vs-roast-review`, `/vs-roast-ui`, `/vs-qa`, `/vs-verify`, `/vs-deslop`, `/vs-brief`, `/vs-second-opinion`, `/vs-perf`, `/vs-to-issues`, `/vs-steal`, `/vs-setup-adr`, `/vs-decide-for-me`, `/vs-out-of-context`, `/vs-recap`, `/vs-retro`, `/vs-try-skill`.
