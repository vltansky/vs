...
flowchart TD
    ...
    C --> B["Prepare PR description<br/>feature_area: title<br/>Problem + one visual + Before/After<br/>Why this change<br/>User impact<br/>Evidence + gaps<br/>Merge risk<br/>Review focus"]
